...
function main() {
  ...
  return (
    <div className='text-gray-600 font-body md:grid grid-cols-3'>
      <div className='md:col-span-1 md:flex md:justify-end'>
        <nav className='text-right'>
          <div className='flex justify-between items-center'>
            <h1 className='font-bold uppercase p-4 border-b border-gray-100'>
              <a href="/" className='hover:text-gray-700'>Food Dan</a>
            </h1>
          ...
          <ul className={`text-sm mt-6 ${isMenuVisible ? "" : "hidden"} md:block`}>
      ...
      <main className='px-16 py-6 bg-gray-100 md:col-span-2'>
        <div className='flex justify-center md:justify-end text-primary'>
          ...
          <a href="#" className='btn ml-2 border-primary md:border-2 hover:bg-primary hover:text-white transition ease-out duration-500'>Sign up</a>
        </div>

        <header>
          <h2 className='text-gray-700 text-6xl font-semibold'>Recipes</h2>
          <h3 className='text-gray-700 text-2xl font-semibold'>For People</h3>
        </header>

        <div>
          <h4 className='font-bold mt-12 pb-2 border-b border-gray-200'>Latest Recipes</h4>

          <div className='mt-8 grid lg:grid-cols-3 lg:gap-10 xl:gap-20'>
            <div className='card'>
              <img src="/img/noodles.jpg" alt="noodles" className='w-full h-32 sm:h-48 object-cover' />
              <div className='m-4'>
